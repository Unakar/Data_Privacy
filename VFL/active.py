...
class LinearActive:
    ...
    def train(self, trainset):
        ...
        for epoch in tbar:
            ...
            for batch in range(n_batches):
                ...
                # -----------------------------------------------------------------
                active_wx = np.dot(self.params, self.x_train[batch_idxes].T)  # TODO
            ...
            self.loss_log.append(epoch_loss / n_batches)
            self.acc_log.append(epoch_acc / n_batches)
    ...
    def _acc(self, y_true, y_hat):
        # Q3. Compute accuracy
        # -----------------------------------------------------------------
        acc = np.mean((y_hat >= 0.5) == y_true)  # TODO
        # -----------------------------------------------------------------
